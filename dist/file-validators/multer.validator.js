...
exports.MulterValidators = void 0;
...
class MulterValidators {
    ...
    static preserveOriginalFileName(req, file, callback) {
        ...
        const randomName = Array(4)
            ...
            .join("");
        callback(null, `${name}${path_1.extname(file.originalname)}`);
    }
    // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
    static editFileName(req, file, callback) {
        ...
        const randomName = Array(16)
            ...
            .map(() => Math.round(Math.random() * 16).toString(16))
            .join("");
        callback(null, `${randomName}${path_1.extname(file.originalname)}`);
    }
}
exports.MulterValidators = MulterValidators;
//# sourceMappingURL=multer.validator.js.map